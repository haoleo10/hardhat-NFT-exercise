...
contract DynamicSvgNFT is ERC721, Ownable {
    //我们要做的事
    // mint
    // 在somewhere 保存SVG information
    // some logic to show "show X image" or "show Y image"
    ...
    //这个函数on chain将svg 转为 image
    //不用ipfs，我们用base64 encoding（可以将svg--》base64 imageURI）
    ...
    //我们不止想要一个image，我们需要metadata，我们需要JSON object，
    //我们需要stick this image to json的image field
    //我们知道ERC721 的tokenURI指向JSON object，
    //我们可以base64(json)变成JSON tokenURI，这是tokenURI that our token uses
